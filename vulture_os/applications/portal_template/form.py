...
#     class Meta:
#         model = Backend
#         fields = ('enabled', 'name', 'mode', 'custom_haproxy_conf',
...
#
#             'tags': TextInput(attrs={'class': 'form-control', 'placeholder': 'Add tags'})
#         }
#
...
#     class Meta:
#         model = Server
#         fields = ('target', 'port', 'tls_profile', 'weight')
#
#         widgets = {
