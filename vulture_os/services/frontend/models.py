...
class Frontend(models.Model):
    ...
    crowdstrike_request_incidents = models.BooleanField(
        verbose_name = _("Get incident logs"),
        help_text = _("Request Crowdstrike incident api"),
        default = True,
    )
    ...
    cisco_umbrella_managed_org_customers_id = models.TextField(
        verbose_name=_("Cisco Umbrella customer ids"),
        help_text=_("Cisco Umbrella customer ids"),
        default="",
    )
    cisco_umbrella_managed_org_dns = models.BooleanField(
        default=True,
        verbose_name=_("Get dns logs"),
        help_text=_("Get dns logs"),
    )
    cisco_umbrella_managed_org_proxy = models.BooleanField(
        default=True,
    ...
    cisco_umbrella_managed_org_parent_expires_at = models.TextField(
        default=""
    )
