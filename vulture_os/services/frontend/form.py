...
from django.forms import (CharField, CheckboxInput, ChoiceField, ModelChoiceField, ModelMultipleChoiceField, Form,
                          ModelForm, NumberInput, Select, SelectMultiple, TextInput, Textarea, ModelChoiceField)
...
class FrontendForm(ModelForm):
    ...
    class Meta:
        ...
        fields = ('enabled', 'tags', 'name', 'mode', 'enable_logging', 'log_level', 'log_condition', 'ruleset',
                  ...
                  'darwin_policy', 'disable_octet_counting_framing', 'enable_logging_body', 'https_redirect',
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            logger.error("Cannot build 'ruleset' choices. Seems that path '{}' is not found: ".format(JINJA_RSYSLOG_PATH))
            logger.exception(e)
