...
class FrontendForm(RsyslogQueueForm, ModelForm):
    ...
    class Meta:
        ...
        fields = ['enabled', 'tags', 'name', 'mode', 'enable_logging', 'log_level', 'log_condition', 'keep_source_fields', 'ruleset',
                  ...
                  'redis_server', 'redis_port', 'tls_profile', 'redis_key', 'redis_password', 'redis_stream_consumerGroup',
        ...
        widgets = {
            ...
            'tenants_config': Select(choices=[], attrs={'class': "form-control select2"}),
            ...
            'error_template': Select(choices=[], attrs={'class': 'form-control select2'}),
            ...
            'api_parser_custom_certificate': Select(choices=[], attrs={'class': "form-control select2"}),
