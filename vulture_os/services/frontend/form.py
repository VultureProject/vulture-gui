...
class FrontendForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name in ['log_condition', 'keep_source_fields', 'ruleset', 'log_level', 'listening_mode',
                           ...
                           'crowdstrike_request_incident','crowdstrike_host','crowdstrike_client_id','crowdstrike_client_secret','crowdstrike_client',
    ...
    class Meta:
        ...
        widgets = {
            ...
            'crowdstrike_request_incident': CheckboxInput(attrs={'class': "js-switch"}),
