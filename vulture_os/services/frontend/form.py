...
class FrontendForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name in ['log_condition', 'keep_source_fields', 'ruleset', 'log_level', 'listening_mode',
                           ...
                           'api_parser_verify_ssl', 'api_parser_custom_certificate', 'api_parser_request_timeout',
    ...
    class Meta:
        ...
        fields = ('enabled', 'tags', 'name', 'mode', 'enable_logging', 'log_level', 'log_condition', 'keep_source_fields', 'ruleset',
                  ...
                  'api_parser_custom_proxy', 'api_parser_verify_ssl', 'api_parser_custom_certificate', 'api_parser_request_timeout',
        ...
        widgets = {
            ...
            'api_parser_request_timeout': NumberInput(attrs={'class': 'form-control'}),
