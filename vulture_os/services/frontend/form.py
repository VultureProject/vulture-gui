...
class FrontendForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name in ['log_condition', 'keep_source_fields', 'ruleset', 'log_level', 'listening_mode',
                           ...
                           'queue_type', 'queue_size', 'dequeue_batch_size', 'nb_workers', 'new_worker_minimum_messages',
                           'shutdown_timeout', 'enable_disk_assist', 'high_watermark', 'low_watermark',
                           'max_file_size', 'max_disk_space', 'spool_directory', 'save_on_shutdown',
