...
class FrontendForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name in ['log_condition', 'keep_source_fields', 'ruleset', 'log_level', 'listening_mode',
                           ...
                           "netskope_host", 'netskope_apikey', 'netskope_page_logs', 'netskope_network_logs', 'netskope_application_logs'
    ...
    class Meta:
        ...
        widgets = {
            ...
            'netskope_page_logs': CheckboxInput(attrs={'class': "js-switch"}),
            'netskope_network_logs': CheckboxInput(attrs={'class': "js-switch"}),
            'netskope_application_logs': CheckboxInput(attrs={'class': "js-switch"}),
