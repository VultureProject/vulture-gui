...
class FrontendForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name in ['log_condition', 'ruleset', 'log_level', 'listening_mode', 'filebeat_listening_mode', 'filebeat_module',
                           ...
                           'forcepoint_username', 'forcepoint_password', "symantec_username", "symantec_password", "symantec_token",
    ...
    class Meta:
        ...
        fields = ('enabled', 'tags', 'name', 'mode', 'enable_logging', 'log_level', 'log_condition', 'ruleset',
                  ...
                  "symantec_username", "symantec_password", "symantec_token", "aws_access_key_id", "aws_secret_access_key",
        ...
        widgets = {
            ...
            "symantec_token": TextInput(attrs={'class': 'form-control'}),
