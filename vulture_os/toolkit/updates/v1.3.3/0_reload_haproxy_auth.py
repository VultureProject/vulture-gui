...
__doc__ = "Update script to reload haproxy conf of workflow with authentication and IDP portals"
    ...
    if not node:
        ...
        try:
            ...
            for idp_portal in UserAuthentication.objects.filter(enable_external=True):
                ...
                print("IDP {} conf reload asked".format(idp_portal))

            print("Restart HAProxy service asked")
