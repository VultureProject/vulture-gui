...
class LDAPRepositoryForm(ModelForm):
    ...
    class Meta:
        ...
        fields = ('name', 'host', 'port', 'protocol', 'encryption_scheme', 'connection_dn', 'dn_password', 'base_dn',
                  ...
                  'enable_oauth2', 'oauth2_attributes', 'oauth2_type_return', 'oauth2_token_return')
        widgets = {
            ...
            'enable_oauth2': CheckboxInput(attrs={'class': 'form-control js-switch'}),
            'oauth2_attributes': TextInput(attrs={'class': 'form-control'}),
            'oauth2_type_return': Select(choices=OAUTH2_TYPE_CHOICES, attrs={'class': 'form-control select2'}),
            'oauth2_token_return': Select(choices=OAUTH2_TOKEN_CHOICES, attrs={'class': 'form-control select2'}),
        }

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Remove the blank input generated by django
        for field_name in ['protocol', 'encryption_scheme', 'user_scope', 'group_scope', 'oauth2_type_return',
                           'oauth2_token_return']:
