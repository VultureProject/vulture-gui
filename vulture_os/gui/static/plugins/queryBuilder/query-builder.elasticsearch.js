...
(function(root, factory) {
    ...
    QueryBuilder.defaults({
        ESBoolOperators: {
            ...
            is_empty:         function(){ return "toto"; },
            is_not_empty:     function(){ return "not_toto"; },
            regex:            function(v){ return v;}
        },
    ...
    */
    function getQueryDSLWord(rule) {
        var term = /^(equal|not_equal|is_empty|is_not_empty)$/.exec(rule.operator),
            ...
            regex = /^(contains|not_contains|begins_with|not_begins_with|ends_with|not_ends_with|regex)$/.exec(rule.operator);

        if (term !== null && wildcard !== null) { return 'wildcard'; }
        if (term !== null) { return 'term'; }
        if (terms !== null) { return 'terms'; }
        if (regex !== null) { return 'regexp'; }
        return 'range';
    }
