    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocols', models.JSONField(default=['tlsv12'], help_text='Allowed protocol ciphers.', verbose_name=models.TextField(choices=[('tlsv12', 'TLSv1.2'), ('tlsv11', 'TLSv1.1'), ('tlsv10', 'TLSv1.0'), ('sslv3', 'SSLv3')]))),
                ('cipher_suite', models.TextField(default='ECDHE-ECDSA-AES256-GCM-SHA384:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-CHACHA20-POLY1305:ECDHE-RSA-CHACHA20-POLY1305:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES256-SHA384:ECDHE-RSA-AES256-SHA384:ECDHE-ECDSA-AES128-SHA256:ECDHE-RSA-AES128-SHA256', help_text='Allowed protocol ciphers.')),
                ('alpn', models.JSONField(default=['h2', 'http/1.1'], help_text='Advertise the TLS ALPN extensions list.', verbose_name=models.TextField(choices=[('h2', 'HTTP2'), ('http/1.1', 'HTTP1.1'), ('http/1.0', 'HTTP1.0')]))),
